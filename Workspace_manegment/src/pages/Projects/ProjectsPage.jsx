...
export default function ProjectsPage() {
  ...
  if (!workspace) return <Card className="p-8"><h1 className="text-lg font-semibold">Workspace unavailable</h1><p className="mt-2 text-sm text-slate-400">This workspace does not exist or you do not have access.</p><Link className="mt-4 inline-block text-violet-600" to="/workspaces">View workspaces</Link></Card>
